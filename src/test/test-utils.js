 ...
 */
exports.buildAssertion = function buildAssertion(
  context,
  moduleName,
  expectedResult
) {
  return function(done) {
    context.instance.externalFunc(relative(), moduleName, function(
      noarg,
      externalModule
    ) {
...
exports.copyModules = function(moduleNames) {
  return Promise.all(
    moduleNames.map(function(moduleName) {
      return copyDir(
        relative('test-webpack', 'modules', moduleName),
        relative('../../node_modules', moduleName)
      )
    })
  )
}
 ...
 * @return {function} the assertion function
 */
exports.webpackAssertion = function webpackAssertion(
  nodeExternalsConfig,
  externals,
  nonExternals
) {
    ...
    webpack(
      {
        ...
        plugins: [new NodeExternals(nodeExternalsConfig)],
        resolve: {
          alias: {
