...
describe('reads from a file', function () {
    ...
    describe('should accept options from file', function () {
        describe(' > include', function () {
            before(function () {
                context.instance = new NodeExternals({ modulesFromFile: { include: ['dependencies'] } })
            })
        ...
        describe(' > exclude', function () {
            before(function () {
                context.instance = new NodeExternals({ modulesFromFile: { exclude: ['dependencies'] } })
            })
        ...
        describe(' > file name', function () {
            before(function () {
                context.instance = new NodeExternals({ modulesFromFile: { fileName: 'noFile.json' } })
            })
